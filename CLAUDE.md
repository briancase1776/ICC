...
- **The session defines the skill. The skill does not define the
  session.** How many inlets, what feeds them, who holds the outlet,
  what goes down one — all the session's. This file says what the
  fitting does and stops there. The moment it starts telling a session
  how to be arranged, it has stopped being the fitting and become
